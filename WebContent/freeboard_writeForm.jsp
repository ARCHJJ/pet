...
function writeCheck()
  ...
  var form = document.writeform;
   ...
   if( !form.title.value )   // form 에 있는 title 값이 없을 때
   {
    ...
    form.title.focus();   // form 에 있는 titles 위치로 이동
    return;
   }
 ...
 <body>
 <form name=writeform method=post action="freeboard_writeOk.jsp">
<table>
  <tr>
   <td>
   ...
   <table>
    ...
    <tr>
      ...
      <td><input type="file" name="file" size="50" maxlength="50">(최대 5M)</td>
      <td>&nbsp;</td>
     </tr>
      <tr height="1" bgcolor="#dddddd"><td colspan="4"></td></tr>
     <tr>
