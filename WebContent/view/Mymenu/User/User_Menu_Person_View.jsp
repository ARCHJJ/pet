...
<body>
	...
	<form name="User_button">
		<button class="ui violet basic button" type="button" onclick="upInfo();">개인정보 수정</button>
		<button class="ui violet basic button" type="button" onclick="delInfo();">비밀번호 변경</button>
			...
			<div class="description">
				...
				<div class="ui input focus">
					<form name="modify_form" method="post"  action="User_Menu_Person.Modi.do">
						...
						<br>
						패스워드 <input type="text" name="password" id="password" maxlength="20" />
						<br>
						...
						<br>
						권한 <input type="text" name="power" id="power" maxlength="20" />
					</form>
				</div>
				<p>수정 하시겠습니까?</p>
			</div>
