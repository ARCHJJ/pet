...
public class MarketDao extends DaoCore {
	...
	public void updateMarket(int market_id, String market_name, String description, String photos, String address, int cl_market, int cl_beauty, int cl_hotel, int cl_hospital,
		...
		try {
			...
			getSqlMapClient().update("MarketDao.updateMarket_a", param);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void updateMarket(int market_id, String market_name, String description, String address, int cl_market,
		...
		try {
			...
			getSqlMapClient().update("MarketDao.updateMarket_b", param);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
